<%-- 
    ...
    Created on : 09-30-2019, 01:31:30 PM
...
<html>
    ...
    <body class="cover">
        ...
        <div class="container-registro">
            ...
            <center>
                <h3 style="font-family: calibri">Registro de Empleados <i class="zmdi zmdi-account-add"></i></h3>
            </center>
            ...
            <form name="f1" id="f1" action="ControlEmpleado" method="POST">                                
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="padding-bottom: 28px;">
                                <input class="mdl-textfield__input" type="text" id="tipoEmpleado" name="tipoEmpleado" >
                                <label class="mdl-textfield__label" for="tipoEmpleado">Tipo Empleado</label>
                            </div>
                        </div>
                        
                        <div class="col-md-6">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="padding-bottom: 28px;">
                                <input class="mdl-textfield__input" type="text" id="pagoDia" name="pagoDia" >
                                <label class="mdl-textfield__label" for="pagoDia">Pago Dia</label>
                            </div>
                        </div>
